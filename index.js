...
const changeBackground = document.querySelector("#util__button-background")

let index = 0;

const colors = ['salmon', 'blue','red','yellow','orange'];

changeBackground.addEventListener("click", function onclick() {
